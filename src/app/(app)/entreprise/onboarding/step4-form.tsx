...
export function Step4Form({
  ...
  const effectif =
    data.sans_salaries
      ? 0
      : data.employees?.length ?? data.effectif ?? 0
    ...
    <div className="fiscow-step4">
      ...
      <div className="fiscow-step4-alert">
        ...
        <div>
          ...
          <p>
            ...
            Vous pourrez les modifier plus tard depuis la page
            Configuration.
          </p>
        </div>
      </div>
      ...
      <section className="fiscow-review-section">
        <div className="fiscow-review-section-head">
          ...
          <div>
            ...
            <p>Informations générales renseignées à l’étape 1.</p>
          </div>
        </div>
        ...
        <div className="fiscow-review-grid">
          ...
          <ReviewItem
            ...
            value={data.date_creation || 'Non renseignée'}
          />
        </div>
      </section>
      ...
      <section className="fiscow-review-section">
        <div className="fiscow-review-section-head">
          ...
          <div>
            <h3>Régime fiscal</h3>
            <p>Informations fiscales et type d’entité.</p>
          </div>
        </div>
        ...
        <div className="fiscow-review-grid">
          <ReviewItem
            label="Régime TVA"
            value={data.regime_tva || '-'}
          />

          <ReviewItem
            label="Type d’entité"
            value={typeEntiteLabel || '-'}
          />

          <ReviewItem
            label="CA annuel"
            value={chiffreAffairesLabel}
          />
        </div>
      </section>
      ...
      <section className="fiscow-review-section">
        <div className="fiscow-review-section-head fiscow-review-section-head-between">
          <div className="fiscow-review-head-main">
            ...
            <div>
              <h3>Employés</h3>
              <p>Effectif et salaires renseignés.</p>
            </div>
          </div>

          <span className="fiscow-review-count">
            {effectif} {effectif === 1 ? 'salarié' : 'salariés'}
          </span>
        </div>

        {data.sans_salaries || !data.employees?.length ? (
          <div className="fiscow-review-empty">
            <i className="ti ti-user-off" />
            <span>Aucun salarié renseigné</span>
          </div>
        ) : (
              ...
              >
                ...
                <div className="fiscow-review-employee-grid">
                  ...
                  <ReviewItem
                    ...
                    value={`${fmt.format(
                      employee.salaire_brut_mensuel ?? 0,
                    )} FCFA`}
                  />
                </div>
              </div>
        ...
        <div className="fiscow-review-property">
          ...
          <span
            className={`fiscow-review-status ${
              data.has_property ? 'is-yes' : 'is-no'
            }`}
          >
            {data.has_property ? 'Oui' : 'Non'}
          </span>
        </div>
      </section>
